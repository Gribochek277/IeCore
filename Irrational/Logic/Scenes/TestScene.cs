...
namespace Irrational.Logic.Scenes
{
    public class TestScene : Scene
    {
        ...
        {
            base.OnLoad();            
            //PointLight light1 = new PointLight(new Vector3(0.1f, 0.1f, 0.1f), 1);
            ...
            //PointLight light3 = new PointLight(new Vector3(0, 0, .3f), 3);
            //light3.Position = new Vector3(2, 0, 0);
            //_sceneObjects.Add(light3);
            //PointLight light4 = new PointLight(new Vector3(.3f, 0, 0), 3);
