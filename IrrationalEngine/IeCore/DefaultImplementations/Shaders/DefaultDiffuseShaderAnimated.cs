...
{
    public class DefaultDiffuseShaderAnimated : DefaultDiffuseShader
    {
        ...
        public new const string VertexShader = @"#version 330
                                               layout(location = 0) in vec3 aPosition;
                                               layout(location = 1) in vec2 aTexCoord;
                                               ...
                                               void main()
                                               {
                                                   ...
                                                   int index = 0;
                                                    ...
                                                    {		
                                                      index = int(BoneIDs[i]);	
                                                      newPosition += (Bones[index] * vec4(aPosition, 1.0)) * Weight[i];		
                                                    }
